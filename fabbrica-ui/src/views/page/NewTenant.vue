    ...
    <q-form>
      <q-toolbar style="border-bottom: 1px solid rgba(0,0,0,0.12);">
        <q-breadcrumbs>
          ...
          <q-breadcrumbs-el label="Tenants" icon="location_city" :to="{ name: 'tenants' }" />
          <q-breadcrumbs-el label="New" icon="add" :to="{ name: 'newTenant' }" />
        </q-breadcrumbs>
        <q-space />
        ...
        <q-card class="full-width q-pa-md">
          <div class="row q-gutter-md">
            <div class="col-md-4 col-sm-6">
              <q-input outlined v-model="code" label="Tenant Code" class="q-mb-sm" />
              <q-input outlined v-model="name" label="Tenant Name" class="q-mb-sm" />
            </div>
